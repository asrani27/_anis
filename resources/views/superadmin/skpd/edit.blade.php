...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" action="/superadmin/skpd/edit/{{$data->id}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kepala" class="form-control" value="{{$data->kepala}}" required>
                    </div>
                    <div class="form-group">
                ...
                <div class="card-footer">
                    ...
                    <a href="/superadmin/skpd" class="btn btn-danger">Kembali</a>
                </div>
            </form>
            <!-- /.card-body -->
        </div>
