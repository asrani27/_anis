...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <form method="POST" action="/superadmin/verifikator/edit/{{$data->id}}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1">Jabatan verifikator</label>
                ...
                <div class="card-footer">
                    ...
                    <a href="/superadmin/verifikator" class="btn btn-danger">Kembali</a>
                </div>
            </form>
            <!-- /.card-body -->
        </div>
